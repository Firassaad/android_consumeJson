...
public class KidsFragment extends Fragment {
    ...
    String urladdress = "https://boutique0.000webhostapp.com/pages/CRUD/WEB_services/ArticlesE.php";
    String[] libelle;
    String[] prix;
    String[] imagepath;
    String[] type;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        collectData();
        ArticleListView articleListView = new ArticleListView(KidsFragment.this, libelle,prix,imagepath ,type);
